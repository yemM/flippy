...
(function($){
    ...
    {    
        ...
        /**
         * Animate the FlipBox
         * @param bool reversing : default false
         * @return void
         */
        ...
        {    
            ...
            switch(this._Direction){
                case "TOP":
                    ...
                    var cv_pattern = '<canvas id="flippy'+this._UID+'" class="flippy" width="'+(this._W+(2*this._CenterX))+'" height="'+this._H+'"></canvas>';
                ...
                case "LEFT":
                    ...
                    var cv_pattern = '<canvas id="flippy'+this._UID+'" class="flippy" width="'+this._W+'" height="'+(this._H+(2*this._CenterY))+'"></canvas>';
                    this.new_flippy(cv_pattern);
                    this.jO.find("#flippy"+this._UID)
                        .css({
                             "position":"absolute",
        ...
        this._Verso = (opts.verso !== undefined)? ((typeof opts.verso == "object") ? opts.verso.html() : opts.verso) : this._Content;
